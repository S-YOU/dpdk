...
type
  ...
  rte_devargs_list* {.importc: "struct rte_devargs_list", header: "rte_devargs.h".} = object
...
type
  rte_pci_resource* {.importc: "struct rte_pci_resource", header: "rte_pci.h".} = object
    phys_addr*: uint64
    len*: uint64
    `addr`*: pointer

  rte_pci_id* {.importc: "struct rte_pci_id", header: "rte_pci.h".} = object
    class_id*: uint32
    vendor_id*: uint16
    device_id*: uint16
  ...
  rte_pci_device* {.importc: "struct rte_pci_device", header: "rte_pci.h".} = object
  ...
  rte_pci_driver* {.importc: "struct rte_pci_driver", header: "rte_pci.h".} = object
  ...
  pci_map* {.importc: "struct pci_map", header: "rte_pci.h".} = object
    `addr`*: pointer
    path*: cstring
    offset*: uint64
    size*: uint64
  ...
  mapped_pci_resource* {.importc: "struct mapped_pci_resource", header: "rte_pci.h".} = object
  ...
  mapped_pci_res_list* {.importc: "struct mapped_pci_res_list", header: "rte_pci.h".} = object
...
proc rte_eal_pci_write_config*(device: ptr rte_pci_device; buf: pointer; len: csize;
                              offset: off_t): cint {.importc, header: "rte_pci.h".}
type
  rte_pci_ioport* {.importc: "struct rte_pci_ioport", header: "rte_pci.h".} = object
